...
000000000040184c <hexmatch>:
  ...
  after call Gets, the stack frame looks like this:
                                       __
        |__________________|             |
        |    exploit code  |             |
        |__________________| 0xb8        |
        |______padding__|  | 0xb0        |  Test stack frame
        |  cookie string   |             |
        |__________________|  0xa8       |
        |  addr of exploit |             |
        |__________________|  0xa0    ___|
        |                  |             |
        |                  |             |
        |      padding     |             |  getbuf stack frame
        |                  |             |
        |__________________|  0x78    __ |
